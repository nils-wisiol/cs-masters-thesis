...
reducible to $(C,D)$, if there exists a polynomial-time computable
function $f$ such that $f(A)\subseteq C$ and $f(B)\subseteq D$.
\end{defn}
...
\item There exists a polynomial-time computable function $f$ such that
