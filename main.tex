...
\subsection{Reducibility of disjoint pairs}
...
\end{proof}
\begin{thm}
If $\NP=\UP$, then ESY-$tt$ does not hold, that is there exists
a disjoint $\NP$-pair such that all separators are truth-table-hard
for $\NP$.\end{thm}
\begin{proof}
...
the class of all almost-tally languages. Meﬂner and Tor·n use the
...
to Kˆbler, Meﬂner and Tor·n. \cite{journals/iandc/KoblerMT03}. However
...
both possibilities are known (see Section \ref{sec:Relativized-Worlds}).
...
\subsection{Existence Optimal and p-Optimal Proof Systems}
...
Previously, Meﬂner and Toran proved \cite{journals/eccc/ECCC-TR97-026}
