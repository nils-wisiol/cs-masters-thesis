...
$j$ is indeed double-logarithmic, and thus $s$ is polynomially bounded
...
\begin{eqnarray*}
 ...
 &  & \qquad\text{(a) all \ensuremath{x_{i}}are pairwise different}\\
 &  & \qquad\text{(b) all \ensuremath{y_{i}}are pairwise different }\\
