...
and $|h(w)|\leq p(|w|)$. We call $h$ a \emph{translation function}.
If $h$ is polynomial-time computable, we say $f$ \emph{p-simulates}
...
the following lemma. A comprehensive proof of it can be found Glaﬂer,
